...
Alpha Male is operated by Hafiz Muhammad Zuhaib, using Synapse Stacks as the product and support brand ("Synapse Stacks," "we," "us," or "our").
...
## 1. What Alpha Male is

Alpha Male is a self-improvement and recovery-support app designed to help users reduce or avoid explicit content, masturbation/fapping habits, compulsive sexual behavior patterns, and related relapse cycles. The Service includes tools such as daily pledges, check-ins, streaks, analytics, goals, journals/accountability notes, urge protocols, relapse recovery flows, reminders, Shield Mode, Alpha Chief AI mentoring, and optional social/accountability features.

Alpha Male is intended to support personal discipline and behavior change. It is not a substitute for professional care.

## 2. Eligibility

You must be at least 18 years old, or the age of majority in your location if higher, to use the Service.

You may use the Service only if you can form a binding agreement with Hafiz Muhammad Zuhaib, operating the Service under the Synapse Stacks product and support brand, and are not prohibited from using the Service under applicable law.

## 3. Important health, safety, and crisis disclaimer

Alpha Male is not a medical device, healthcare provider, therapy service, addiction treatment program, crisis service, emergency service, legal adviser, or financial adviser.

The Service does not diagnose, treat, cure, or prevent any disease, disorder, addiction, or mental health condition. Any content, coaching, AI response, protocol, reminder, score, risk band, or suggestion is for informational and self-improvement purposes only.

If you are in immediate danger, may harm yourself or another person, or need urgent help, call local emergency services immediately. If you need medical, mental health, or addiction care, contact a qualified professional.

You are responsible for deciding whether and how to use the Service and for seeking professional help when needed.

## 4. Account registration and security

You may need an account to use parts of the Service. You agree to provide accurate information, keep your account secure, and notify us if you suspect unauthorized access.

You are responsible for activity under your account, except where unauthorized activity results from our failure to use reasonable security measures.

You may not create accounts using false, misleading, abusive, or unlawful information.

## 5. Privacy

Our Privacy Policy explains how we collect, use, disclose, retain, and protect information. By using the Service, you acknowledge our Privacy Policy.
...
You keep ownership of your User Content, subject to the rights you grant below.

You grant Hafiz Muhammad Zuhaib, operating the Service under the Synapse Stacks product and support brand, a worldwide, non-exclusive, royalty-free license to host, store, process, reproduce, display, transmit, modify for formatting, analyze, and use your User Content as needed to:

- Provide and improve the Service.
- Generate scores, summaries, insights, reminders, and AI responses.
- Display content you choose to share.
- Operate social/accountability features.
- Provide support.
...
- Is pornographic, erotic, sexually explicit, or intended to arouse.
- Sexualizes minors or appears to involve minors in any sexual context.
- Promotes sexual exploitation, abuse, trafficking, coercion, or non-consensual sexual behavior.
- Encourages relapse, self-harm, suicide, violence, abuse, stalking, harassment, bullying, hate, or illegal activity.
- Contains threats or targeted harassment.
- Reveals another person's private information without permission.
- Impersonates someone else or misrepresents your identity.
...
- Alpha Chief is not a therapist, doctor, sponsor, emergency responder, or professional adviser.
- You will not rely on Alpha Chief for emergencies, diagnosis, treatment, legal advice, financial advice, or decisions that require a licensed professional.
- You are responsible for evaluating AI outputs before acting on them.
- You will not use Alpha Chief to create erotic content, exploitative content, harassment, illegal content, or other content that violates these Terms.
- We may route messages to third-party AI infrastructure to generate responses, as described in the Privacy Policy.
...
Shield Mode is not guaranteed to block every explicit website, app, image, message, search result, browser, proxy, VPN, private-browsing session, or workaround. You remain responsible for your device choices and behavior.
...
- Use the Service for harassment, exploitation, abuse, threats, stalking, hate, or illegal activity.
- Upload malicious code or attempt to disrupt the Service.
- Reverse engineer, scrape, overload, probe, or attack the Service except as permitted by law.
- Access another user's account or data without permission.
- Circumvent security, moderation, rate limits, payment systems, or platform restrictions.
- Use the Service to generate or distribute pornographic, exploitative, abusive, or unlawful content.
...
We may suspend or terminate your access to the Service if we believe you violated these Terms, created risk for other users, abused the Service, created legal risk, or used the Service in a harmful or unlawful way.
...
- Recovery tools will prevent relapse or explicit-content use.
- Shield Mode will block all unwanted apps, websites, content, or workarounds.
- Scores, risk bands, summaries, or AI responses will be accurate.
- Notifications will be delivered at a specific time or at all.
- Social/accountability features will be free from harmful, inaccurate, or offensive content.
...
To the fullest extent permitted by law, our total liability for any claim related to the Service will not exceed the greater of: (a) the amount you paid us for the Service in the 12 months before the claim, or (b) USD $100.
...
- These Terms are between you and Hafiz Muhammad Zuhaib, operating the Service under the Synapse Stacks product and support brand, not Apple.
...
- If the Service fails to conform to an applicable warranty, you may notify Apple and Apple may refund the purchase price, if any, according to Apple's rules.
